...
OBJS		= kernel/kernel.o lib/syscall.o kernel/start.o kernel/main.o\
			...
			game/pushBox.o game/migong.o game/rili.o game/saolei.o\
			lib/printf.o lib/vsprintf.o\
			lib/kliba.o lib/klib.o lib/string.o lib/misc.o\
			lib/open.o lib/read.o lib/write.o lib/close.o lib/unlink.o\
			lib/getpid.o lib/syslog.o lib/calculator.o lib/booting.o\
			lib/command.o\
			fs/main.o fs/open.o fs/misc.o fs/read_write.o\
			fs/link.o fs/FileSystem.o\
			fs/disklog.o
...
lib/calculator.o: lib/calculator.c
	$(CC) $(CFLAGS) -o $@ $<

lib/booting.o: lib/booting.c
	$(CC) $(CFLAGS) -o $@ $<
...
game/pushBox.o: game/pushBox.c
	$(CC) $(CFLAGS) -o $@ $<
	
game/migong.o: game/migong.c
	$(CC) $(CFLAGS) -o $@ $<
